...
TRUNCATE TABLE Bestelling_menuItems RESTART IDENTITY;
TRUNCATE TABLE BestellingVerzameling RESTART IDENTITY;
TRUNCATE TABLE BestellingVerzameling_bestellingen RESTART IDENTITY;
TRUNCATE TABLE Dag RESTART IDENTITY;
TRUNCATE TABLE Klant RESTART IDENTITY;
TRUNCATE TABLE Klant_bestellingVerzamelingen RESTART IDENTITY;
TRUNCATE TABLE Menu RESTART IDENTITY;
TRUNCATE TABLE Menu_menuItems RESTART IDENTITY;
TRUNCATE TABLE MenuItem RESTART IDENTITY;
TRUNCATE TABLE Openingsuren RESTART IDENTITY;
TRUNCATE TABLE Openingsuren_dagen RESTART IDENTITY;
TRUNCATE TABLE Reservatie RESTART IDENTITY;
TRUNCATE TABLE Tafel RESTART IDENTITY;
TRUNCATE TABLE Uitbater RESTART IDENTITY;
TRUNCATE TABLE Zaak RESTART IDENTITY;
TRUNCATE TABLE Zaak_tafels RESTART IDENTITY;
...
VALUES (1, 'Bistro Mehmet', 1, 5, 3, 1, 2, 'mehmet@jammik.be'),
       ...
       (3, 'Bistro Koen', 1, 5, 2, 2, 3, 'koen@jammik.be'),
